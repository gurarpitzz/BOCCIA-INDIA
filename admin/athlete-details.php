    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-body p-4">
                <p class="text-dark">You are about to delete the athlete profile for <strong><?php echo htmlspecialchars($athlete['full_name']); ?></strong> (Reg No: <?php echo htmlspecialchars($athlete['regn_no']); ?>).</p>
                <p class="text-danger fw-semibold"><i class="fa-solid fa-circle-exclamation me-1"></i> Warning: This action will restrict this profile from registry databases, audits, and tournament directories. This action is logged.</p>
