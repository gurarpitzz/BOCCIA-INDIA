        ...
        <div class="split-card-container">
            ...
            <div class="split-card-right">
                <div class="form-header-box">
                    ...
                    <h2 class="form-title-text" id="wizard-title-label">Official Registration Wizard</h2>
                </div>
                    ...
                    <div class="wizard-step" id="wizard-step-3">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="aadhaar" class="form-control-custom" required>
                            </div>
...
function submitApplication() {
    ...
    fetch("../api/official-registration.php", {
        method: "POST",
        body: fd
    })
    .then(async res => {
