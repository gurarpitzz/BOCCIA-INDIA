            ...
            <nav aria-label="Page navigation">
                <ul class="pagination pagination-md shadow-sm rounded-pill overflow-hidden border-0">
                    <?php if ($currentPage > 1): ?>
                        <li class="page-item">
                            <a class="page-link border-0 px-3 py-2 text-dark fw-bold" href="officials-database.php?page=<?php echo $currentPage - 1; ?>&search=<?php echo urlencode($search); ?>&state=<?php echo urlencode($stateFilter); ?>&role=<?php echo urlencode($roleFilter); ?>" aria-label="Previous">
                    ...
                    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                        <li class="page-item <?php echo $i === $currentPage ? 'active' : ''; ?>">
                            <a class="page-link border-0 px-3 py-2 <?php echo $i === $currentPage ? 'bg-primary text-white' : 'text-dark'; ?> fw-bold" href="officials-database.php?page=<?php echo $i; ?>&search=<?php echo urlencode($search); ?>&state=<?php echo urlencode($stateFilter); ?>&role=<?php echo urlencode($roleFilter); ?>">
                                <?php echo $i; ?>
                            </a>
                        </li>
                    <?php endfor; ?>
                    ...
                    <?php if ($currentPage < $totalPages): ?>
                        <li class="page-item">
                            <a class="page-link border-0 px-3 py-2 text-dark fw-bold" href="officials-database.php?page=<?php echo $currentPage + 1; ?>&search=<?php echo urlencode($search); ?>&state=<?php echo urlencode($stateFilter); ?>&role=<?php echo urlencode($roleFilter); ?>" aria-label="Next">
