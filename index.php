...
function resolveWebPath(?string $path): string {
    ...
    <svg width="0" height="0" style="position: absolute; width: 0; height: 0;">
      <defs>
        <clipPath id="star-clip-path" clipPathUnits="objectBoundingBox">
          <path transform="scale(0.01)" d="M 47.73,10.56 Q 50.00,5.00 52.27,10.56 L 59.49,28.26 Q 61.76,33.82 67.74,34.26 L 86.81,35.66 Q 92.80,36.09 88.21,39.97 L 73.60,52.31 Q 69.02,56.18 70.45,62.01 L 75.02,80.58 Q 76.45,86.41 71.35,83.24 L 55.10,73.16 Q 50.00,70.00 44.90,73.16 L 28.65,83.24 Q 23.55,86.41 24.98,80.58 L 29.55,62.01 Q 30.98,56.18 26.40,52.31 L 11.79,39.97 Q 7.20,36.09 13.19,35.66 L 32.26,34.26 Q 38.24,33.82 40.51,28.26 Z" />
        </clipPath>
      </defs>
    </svg>
    ...
    <div id="galMainBrowseView">
        ...
        <div class="gal-albums-grid" style="margin-bottom: 4rem;">
            <?php foreach ($featuredAlbums as $alb): 
                ...
                $coverSrc = htmlspecialchars(resolveWebPath($rawCover));
            ?>
