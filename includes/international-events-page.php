...
$eventTypes = array_unique(array_filter(array_column($internationalSchedules, 'event_type')));
sort($eventTypes);
            ...
            <?php if (count($internationalSchedules) > 0): ?>
                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-6 col-md-3">
                            ...
                            <select id="eventTypeFilter" class="form-select rounded-pill py-2" style="font-size: 0.95rem;">
                                <option value="">All Types (<?php echo count($internationalSchedules); ?>)</option>
                ...
                <div class="schedule-table-card">
                    ...
                    <div id="noMatchingEvents" style="display: none; text-align: center; padding: 4rem 1.5rem;">
                        ...
                        <p style="color: #64748B; margin-bottom: 1.5rem;">No international events match your current search and filter criteria.</p>
