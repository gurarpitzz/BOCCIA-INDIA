<?php
// includes/myas/mandatory-disclosures-table.php - Shared Disclosures Table and Search Component
?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="font-size: 0.85rem;" class="text-muted mt-1">
                                    ...
                                    <a href="uploads/documents/Bye_Laws_BSFI_2023.pdf" target="_blank" class="d-inline-flex align-items-center mt-1 text-decoration-none fw-semibold text-primary">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="font-size: 0.85rem;" class="text-muted mt-1">
                                    ...
                                    <a href="uploads/documents/Affiliation_with_World_Boccia.pdf" target="_blank" class="d-inline-flex align-items-center mt-1 text-decoration-none fw-semibold text-primary">
                                        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" class="me-1"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg> View World Boccia Affiliation
                                    </a>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-success-subtle text-success px-3 py-2 rounded-pill fw-bold mb-2">YES</span>
                                <div style="font-size: 0.85rem;" class="text-muted mt-1">
                                    Sanctions & Utilization records.
                                    <a href="page.php?section=myas&slug=administrative-sanction" class="d-inline-flex align-items-center mt-1 text-decoration-none fw-semibold text-primary">
                                        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" class="me-1"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg> View Sanctions & Clearances
                                    </a>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="font-size: 0.85rem;" class="text-muted mt-1">
                                    <a href="page.php?section=competitions&slug=national-events" class="d-inline-flex align-items-center mt-1 text-decoration-none fw-semibold text-primary">
                                        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" class="me-1"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg> View National Calendar
                                    </a>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="font-size: 0.85rem;" class="text-muted">
                                    ...
                                    <br>
                                    <a href="page.php?section=myas&slug=athlete-prevention" class="d-inline-flex align-items-center mt-1 text-decoration-none fw-semibold text-primary">
                                        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" class="me-1"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg> Age Fraud Prevention
                                    </a>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="font-size: 0.85rem;" class="text-muted">
                                    ...
                                    <br>
                                    <a href="uploads/documents/Posh_Committee.pdf" target="_blank" class="d-inline-flex align-items-center mt-1 text-decoration-none fw-semibold text-primary me-3">
                                        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" class="me-1"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg> View POSH Committee
                                    </a>
                                    <br>
                                    <a href="uploads/documents/internal_grievance_redressal_committee.pdf" target="_blank" class="d-inline-flex align-items-center mt-1 text-decoration-none fw-semibold text-primary">
                                        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" class="me-1"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg> View Complaints Committee (Grievance Cell)
                                    </a>
                                </div>
                            </td>
                        </tr>
