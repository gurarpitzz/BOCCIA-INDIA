            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="card border-0 shadow-sm p-4 p-md-5" style="border-radius: 24px; background:#ffffff;">
                    ...
                    <div class="border-top mt-4 pt-4 d-flex align-items-center gap-3 flex-wrap">
                        ...
                        <div class="d-flex gap-2">
                            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode('http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']); ?>" target="_blank" class="btn btn-sm btn-primary rounded-pill px-3" style="font-size: 0.78rem;"><i class="fa-brands fa-facebook-f me-1"></i> Facebook</a>
                            <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode('http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']); ?>&text=<?php echo urlencode($article['title']); ?>" target="_blank" class="btn btn-sm btn-dark rounded-pill px-3" style="font-size: 0.78rem;"><i class="fa-brands fa-x-twitter me-1"></i> Share</a>
                            <a href="https://api.whatsapp.com/send?text=<?php echo urlencode($article['title'] . ' - ' . 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']); ?>" target="_blank" class="btn btn-sm btn-success rounded-pill px-3" style="font-size: 0.78rem;"><i class="fa-brands fa-whatsapp me-1"></i> WhatsApp</a>
                            <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo urlencode('http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']); ?>&title=<?php echo urlencode($article['title']); ?>" target="_blank" class="btn btn-sm btn-primary rounded-pill px-3" style="font-size: 0.78rem; background:#0A66C2;"><i class="fa-brands fa-linkedin-in me-1"></i> LinkedIn</a>
                        </div>
                    </div>
